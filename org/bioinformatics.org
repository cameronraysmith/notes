...
#+hugo_slug: bioinformatics
#+TITLE: bioinformatics
* general sequencing pipelin
** bcbio-nextgen
...
** read alignment and calibration
...
*** [[https://uswest.ensembl.org/info/docs/tools/vep/index.html][Ensemble VEP]]: variant annotation
** output
*** QC
**** FASTQC report
**** Duplicate reads
